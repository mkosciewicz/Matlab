% Notatki
%   -----
% W metodzie "globalnej" do obliczenia progu Otsu wykorzystuje się histogram obrazu z 256 komór.
% Aby wygenerować obraz binarny z obrazu indeksowanego, należy najpierw przekonwertować obraz na obraz intensywności za pomocą narzędzia IND2GRAY. Aby utworzyć obraz intensywności w skali szarości z obrazu RGB, należy najpierw użyć narzędzia RGB2GRAY do przekształcenia obrazu na obraz intensywności w skali szarości.
% IMBINARIZE przewiduje, że obrazy zmiennoprzecinkowe będą znormalizowane w zakresie [0,1].
